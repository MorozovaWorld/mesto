...
export const formElementEditProfPic = document.querySelector('.popup__form_action_add-profile-picture');
export const editProfPicBtn = document.querySelector('.profile__image-edit-btn');
...
export const popupEditProfPicSubmitBtn = formElementEditProfPic.querySelector('.popup__button-submit');
...
export const userPic = document.querySelector('.profile__image');
